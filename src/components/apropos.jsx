    ...
    <>
      <section id="apropos">
        <div className="container">
          <h2 className="text-center p-3 mt-5">À propos</h2>
          <p className="p-3 m-3">
            ...
            votre satisfaction sont notre priorité absolue.<br/><br/><button onClick={scrollToContact}><span>Retour a la carte</span></button>
          </p>
